...
async def root(request: Request):
    ...
    if is_browser:
        ...
        return {
            "message": "Aclimate Frontend Users v3 API",
            "version": "3.0",
            "description": "API for managing users, authentication, and weather station preferences for AClimate frontend applications.",
            "docs": "/docs",
